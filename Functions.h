...
void assignUsedCell( int matrixWhereToAssign[ NO_LIN_COL + 1 ][ NO_LIN_COL + 1 ], player currentPlayer, int whichPlayer )
{
...
void movePawn( int matrixWhereToAssign[ NO_LIN_COL + 1 ][ NO_LIN_COL + 1 ], player &currentPlayer, int whichPlayer, int newLine, int newColumn )
{
...
void setNeededDataFourPlayers( int matrixWhereToAssign[ NO_LIN_COL + 1 ][ NO_LIN_COL + 1 ], int whichPlayer )
{
	...
	assignUsedCell( matrixWhereToAssign, firstPlayer, 1 );
	assignUsedCell( matrixWhereToAssign, secondPlayer, 0 );
	assignUsedCell( matrixWhereToAssign, thirdPlayer, 2 );
	assignUsedCell( matrixWhereToAssign, fourthPlayer, 3 );
}
